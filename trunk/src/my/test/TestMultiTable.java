...
import org.apache.log4j.Logger;
	 ...
	 * [zhouhh@Hadoop48 ~]$ cat cars.csv
		...
		hadoop jar TestMultiTable.jar cars.csv
	 */
	...
	public class TestMultiTable extends Configured implements Tool {
	    ...
	    private Job getMultiTableOutputJob(String name, Path inputFile) throws IOException {
	        if (LOG.isInfoEnabled()) {
	            ...
	            LOG.info("zhh: JAVA_HOME:"+ System.getenv("JAVA_HOME") );
	            LOG.info("zhh: HADOOP_CLASSPATH:"+ System.getenv("HADOOP_CLASSPATH") );
	        }
