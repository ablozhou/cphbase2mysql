...
/*	public static final String HBASE_CONFIGURATION_ZOOKEEPER_QUORUM       = "hbase.zookeeper.quorum";
  ...
  */
    ...
    static {  
        ...
        //configuration.set("hbase.zookeeper.quorum", "192.168.10.48");  
        //configuration.set("hbase.master", "192.168.10.48:60000");  
    }  
  
    public static void main(String[] args) {  
        // createTable("zhhtest");  
        insertData("zhhtest","myrow4","column3","hello world4");  
        // QueryAll("zhhtest");  
        // QueryByCondition1("zhhtest");  
        // QueryByCondition2("zhhtest");  
        //QueryByCondition3("zhhtest");  
        //deleteRow("zhhtest","abcdef");  
        QueryAll("zhhtest");
        //deleteByCondition("zhhtest","abcdef");  
    }  
     ...
     * @param tableName 
     */  
    public static void insertData(String tableName,String row,String colum,String value) {  
        ...
        */
        ...
        put.add(colum.getBytes(),null,value.getBytes());
        try {  
            table.put(put);  
        } catch (IOException e) {  
            e.printStackTrace();  
